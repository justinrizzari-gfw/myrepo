...
AND
---HANNAH: to reduce query size here you use _PARTITIONTIME instead of timestamp
--- ADEL: updated below note this reduced from TB to 15 GB
_PARTITIONTIME>=minimum()
AND
_PARTITIONTIME<=maximum()
ORDER BY
timestamp
")
...
Q -- so my queries I think were right on this one, just not the intepretation. Think th
