...
WHERE
 ...
 --and DATE(first_timestamp) >'2018-01-01' and
 --DATE(last_timestamp) < '2018-12-31'

group by ssvid, shipname,imo, callsign, flag,is_carrier,   first_timestamp, last_timestamp, r.list_uvi,
  r.authorized_from,
  r.authorized_to,
geartype_original